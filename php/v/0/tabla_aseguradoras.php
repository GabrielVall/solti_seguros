...
$sql = new SQLConexion();
$resultado = $sql->obtenerResultado('CALL sp_select_aseguradoras()');
...
if ($total_resultado > 0) {
    for($i = 0; $i < $total_resultado; $i++){ ?>
        <tr>
            ...
            <td><?php echo $resultado[$i]['nombre_aseguradora']; ?></td>
            <td style="display:flex;justify-content:space-around;" data-id="<?php echo $resultado[$i][9]; ?>">
                <a href="javascript:void(0);" class="btn btn-success btn-sm" id="editar_aseguradora">
