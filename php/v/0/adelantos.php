<div class="row">
    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12" id="form_adelanto_content">
        <?php include('../../v/0/form_adelantos.php'); ?>
    </div>
                    ...
                    <table class="table table-bordered table-striped mg-b-0 text-md-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th>Cantidad adelantada</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                        <tbody id="tabla_consulta">
                        <?php include('../../v/0/tabla_adelantos.php'); ?>
                        </tbody>
                    </table>
                </div>
                <!-- bd -->
